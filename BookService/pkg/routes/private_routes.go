...
func PrivateRoutes(a *fiber.App) {
	...
	v1.Get("/books/detail/:id", middleware.JWTProtectedG, httpHandler.GetBook)
	...
	v1.Get("/books/search", middleware.JWTProtectedG, httpHandler.Search)
	v1.Get("/books/recommended", middleware.JWTProtectedG, httpHandler.GetRecommend)
}
